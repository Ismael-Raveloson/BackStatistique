...
INSERT INTO Ligue VALUES ('L' +  CAST(NEXT VALUE FOR ligueSeq AS VARCHAR) ,'Bundesliga');
INSERT INTO Ligue VALUES ('L' +  CAST(NEXT VALUE FOR ligueSeq AS VARCHAR) ,'Ligue 1');
INSERT INTO Ligue VALUES ('L' +  CAST(NEXT VALUE FOR ligueSeq AS VARCHAR) ,'Premier League');
INSERT INTO Ligue VALUES ('L' +  CAST(NEXT VALUE FOR ligueSeq AS VARCHAR) ,'LaLiga');
INSERT INTO Ligue VALUES ('L' +  CAST(NEXT VALUE FOR ligueSeq AS VARCHAR) ,'Serie A');
...
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Bayern Munich','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Paris Saint-Germain','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Bayer Leverkusen','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Manchester City','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Real Madrid','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Inter','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'VfB Stuttgart','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Atletico Madrid','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Barcelona','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Newcastle','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Tottenham','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Arsenal','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Liverpool','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Monaco','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'RB Leipzig','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Napoli','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Aston Villa','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Juventus','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Lille','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Girona','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Marseille','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Roma','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Real Betis','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Nice','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Manchester United','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Everton','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Chelsea','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Crystal Palace','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Hoffenheim','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Brest','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Sheffield United','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Valencia','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Sevilla','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Mallorca','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Strasbourg','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Las Palmas','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Wolves','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Reims','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Bochum','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Montpellier','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Nottingham Forest','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Bournemouth','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'FC Koln','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Clermont Foot','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Lorient','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Lyon','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Luton','L3');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Mainz 05','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Udinese','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Eintracht Frankfurt','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'AC Milan','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Empoli','L5');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Freiburg','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Lens','L2');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Granada','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Bayer Leverkusen','L1');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'Villarreal','L4');
INSERT INTO Equipe VALUES ('E' +  CAST(NEXT VALUE FOR equipeSeq AS VARCHAR),'West Ham','L3');
...
INSERT INTO Categorie VALUES ('CAT' +  CAST(NEXT VALUE FOR categorieSeq AS VARCHAR),'Domicile');
INSERT INTO Categorie VALUES ('CAT' +  CAST(NEXT VALUE FOR categorieSeq AS VARCHAR),'Exterieur');
...
CREATE TABLE StatsEquipeGeneral(
	idEquipe varchar(10),
	buts decimal(5,2),
	tirMatch decimal(5,2),
	cartonJaune decimal(5,2),
	cartonRouge decimal(5,2),
	possession decimal(5,2),
	passesReussies decimal(5,2),
	aerienGagnes decimal(5,2),
	note decimal(5,2),
...
SELECT * FROM StatsEquipeGeneral;
...
FROM
    StatsEquipeGeneral
    INNER JOIN Equipe ON StatsEquipeGeneral.idEquipe = Equipe.idEquipe
    INNER JOIN Ligue ON Equipe.idLigue = Ligue.idLigue
WHERE
    idCategorie = 'CAT1';



CREATE VIEW statsEquipeGeneralExterieur AS
...
CREATE VIEW statsEquipeGeneralGeneral AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       SUM(buts) AS buts,
       AVG(tirMatch) AS tirMatch,
       SUM(cartonJaune) AS cartonJaune,
       SUM(cartonRouge) AS cartonRouge,
       AVG(possession) AS possession,
       AVG(passesReussies) AS passesReussies,
       AVG(aerienGagnes) AS aerienGagnes,
       AVG(note) AS note
FROM StatsEquipeGeneral
JOIN Equipe ON StatsEquipeGeneral.idEquipe = Equipe.idEquipe
JOIN Ligue ON Equipe.idLigue = Ligue.idLigue
...
CREATE TABLE StatsEquipeDefense(
	idEquipe varchar(10),
	tirMatch decimal(5,2),
	tacleMatch decimal(5,2),
	interceptionMatch decimal(5,2),
	fauteMatch decimal(5,2),
	horsJeuxMatch decimal(5,2),
	note decimal(5,2),
	idCategorie varchar(10),
	FOREIGN KEY (idEquipe) REFERENCES Equipe(idEquipe),
	FOREIGN KEY (idCategorie) REFERENCES Categorie(idCategorie)
...
CREATE VIEW statsEquipeDefenseDomicile AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       tirMatch,
       tacleMatch,
...
CREATE VIEW statsEquipeDefenseExterieur AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       tirMatch,
       tacleMatch,
...
CREATE VIEW statsEquipeDefenseGeneral AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       AVG(tirMatch) AS tirMatch,
...
CREATE TABLE StatsEquipeAttaque(
	idEquipe varchar(10),
	tirMatch decimal(5,2),
	tirCadreMatch decimal(5,2),
	dribbleMatch decimal(5,2),
	fauteSubieMatch decimal(5,2),
	note decimal(5,2),
	idCategorie varchar(10),
	FOREIGN KEY (idEquipe) REFERENCES Equipe(idEquipe),
	FOREIGN KEY (idCategorie) REFERENCES Categorie(idCategorie)
...
CREATE VIEW statsEquipeAttaqueDomicile AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       tirMatch,
       tirCadreMatch,
...
CREATE VIEW statsEquipeAttaqueExterieur AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       tirMatch,
       tirCadreMatch,
...
CREATE VIEW statsEquipeAttaqueGeneral AS
SELECT Equipe.nom AS equipe,
       Ligue.nom AS ligue,
       AVG(tirMatch) AS tirMatch,
       AVG(tirCadreMatch) AS tirCadreMatch,
       AVG(dribbleMatch) AS dribbleMatch,
       AVG(fauteSubieMatch) AS fauteSubieMatch,
       AVG(note) AS note
FROM StatsEquipeAttaque
JOIN Equipe ON StatsEquipeAttaque.idEquipe = Equipe.idEquipe
JOIN Ligue ON Equipe.idLigue = Ligue.idLigue
